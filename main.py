...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        help="CGCNN_demo, MPNN_demo, SchNet_demo, MEGNet_demo, GCN_net_demo, SOAP_demo, SM_demo，DEEP_GATGNN_demo",
    )
    parser.add_argument(
        "--seed",
        default=54321,
    ...
    parser.add_argument(
        "--data_path",
        default="/home/u2023170633/deeperGATGNN-main/moxing/data/bulk",
        type=str,
        help="Location of data containing structures (json or any other valid format) and accompanying files",
    )
    parser.add_argument("--format", default='vasp', type=str, help="format of input data")     ### 这里的vasp也是支持的
    # parser.add_argument("--format", default="vasp", type=str, help="format of input data")
